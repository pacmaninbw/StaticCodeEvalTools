...
FileStatistics::FileStatistics()
	: totalLineCount{ 0 }, codeLineCount{ 0 }, commentLineCount{ 0 }, whiteSpaceCount{ 0 },
	wordCount{ 0 }, characterCount{ 0 }, codeWithCommentCount{ 0 }
{
...
FileStatistics::FileStatistics(std::string inFileName)
	: totalLineCount{ 0 }, codeLineCount{ 0 }, commentLineCount{ 0 }, whiteSpaceCount{ 0 },
	wordCount{ 0 }, characterCount{ 0 }, codeWithCommentCount{ 0 }, fileName{ inFileName }
{
